...
(function(electroscope){
  ...
  var drawStateDetail = function(state){
    ...
    $.getJSON("http://128.199.69.68:3000/seperate_topo_upper/" + state + ".topojson", function(data){
  ...
  var renderIndividualParliamentData = function(state){
    ...
    $.getJSON("http://128.199.69.68:3000/api/candidates/count/by-party?group_by=parliament&state_code=" + state, function(response){
