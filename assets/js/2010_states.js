...
(function(electroscope){
  ...
  var drawStateDetail = function(state){
    ...
    electroscope.getJSON("/seperate_topo_upper/" + state + ".topojson", function(data){
    ...
    // electroscope.getJSON("https://api.electroscope.info/api/candidates/count/by-parliament?state=" + state, function(response){
  ...
  var renderIndividualParliamentData = function(state){
    ...
    electroscope.getJSON("/api/candidates/count/by-party?group_by=parliament&state_code=" + state, function(response){
