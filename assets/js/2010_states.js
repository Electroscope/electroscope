...
(function(electroscope){
  ...
  var drawStateDetail = function(state){
    ...
    $.getJSON("http://127.0.0.1:3000/seperate_topo_upper/" + state + ".topojson", function(data){
    ...
    // $.getJSON("http://127.0.0.1:3000/api/candidates/count/by-parliament?state=" + state, function(response){
  ...
  var renderIndividualParliamentData = function(state){
    ...
    $.getJSON("http://127.0.0.1:3000/api/candidates/count/by-party?group_by=parliament&state_code=" + state, function(response){
